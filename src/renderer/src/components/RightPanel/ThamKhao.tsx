    ...
    <>
      ...
      <div className="panel-section">
        ...
        <div className="tham-khao__card">
          <div className="tham-khao__card-title">{primaryHex.fullName} · {primaryHex.character}</div>
      ...
      <div className="panel-section">
        ...
        ].map(({ label, trigram }) => trigram ? (
          <div key={label} className="tham-khao__card" style={{ marginBottom: 8 }}>
            <div className="tham-khao__card-title">{label} — {trigram.name} ({trigram.chinese})</div>
            <div className="tham-khao__card-text">
              Tượng <strong>{trigram.nature}</strong> · Ngũ hành <strong>{trigram.element}</strong> ·{' '}
              Hướng <strong>{trigram.direction}</strong>.<br />
      ...
      <div className="panel-section">
        ...
        <div className="tham-khao__card">
          <div className="tham-khao__card-text" style={{ fontSize: 12, lineHeight: 1.7 }}>
            <p>• <strong>Hào dương (—)</strong>: 少阳/老阳 — hào đặc (giá trị 7 hoặc 9)</p>
            <p>• <strong>Hào âm (- -)</strong>: 少阴/老阴 — hào đứt (giá trị 6 hoặc 8)</p>
            <p>• <strong>Hào động (○/×)</strong>: Lão dương (9) hoặc Lão âm (6) — hào biến đổi</p>
            <p>• <strong>Quẻ gốc</strong>: Từ hào hiện tại đọc tình trạng hiện tại</p>
            <p>• <strong>Quẻ biến</strong>: Sau khi hào động chuyển, cho thấy kết quả/tương lai</p>
          </div>
        </div>
      </div>
    </>
